...
//  { path: 'nfc-pick-page', loadChildren: './picy/nfc-pick-page/nfc-pick-page.module#NfcPickPagePageModule' },
  ...
  { path: 'nfc', loadChildren: './picy/nfc/nfc.module#NfcPageModule' },
  { path: 'cury', loadChildren: './cury/cury/cury.module#CuryPageModule' },
  { path: 'carousel', loadChildren: './cury/carousel/carousel.module#CarouselPageModule' },
